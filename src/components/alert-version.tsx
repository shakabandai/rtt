...
* @see https://v0.dev/t/tt7nZWP6Qx2
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <CardContent>
            <div className="grid gap-4">
              ...
              <Alert className="bg-red-500 text-white" variant="destructive">
                ...
                <AlertDescription>Session does not exist.</AlertDescription>
              </Alert>
      ...
      <div className="flex h-full overflow-hidden">
        ...
        <div className="px-6 py-4 flex flex-col gap-4 flex-1 bg-[rgb(20,27,45)] overflow-auto">
          ...
          <main className="flex-1 p-6 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 bg-[rgb(20,27,45)] text-[#ffffff]">
